# HUAWEI Wallet Kit Server Demo (C# Version)
### Table of Contents
...
Visual Studio 2019 or above, or VSCode with C# extensions are recommended.
...
Before running the Demo project, you need to set the configuration values "appId", "appSecret", "cardType", "site", and "jweSignPrivateKey" in the "test\InstanceTest.cs", "test\ModelTest.cs", and "test\JweTest.cs" files.

#### Set "appId" and "appSecret":
Go to the [AGC website](https://developer.huawei.com/consumer/en/service/josp/agc/index.html), login to your account, click "My apps" and then click the app you want to operate. Then you can find its App ID and App secret.
...
Input parameters of models and instances are passed by JSON files in the Demo project. You can generate your own data by modifying the JSON files in the "test\resource" folder.<br>
...
Install dependencies in the "src\src.csproj" and "test\test.csproj" files.
...
## License
HUAWEI Wallet Kit Server Demo (C# Version) is licensed under the [Apache License, version 2.0](http://www.apache.org/licenses/LICENSE-2.0).
