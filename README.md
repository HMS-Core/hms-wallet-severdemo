...
Before you use this Demo, it's assumed that you already have a HUAWEI developer account and have already created an app to implement the HMS wallet kit. If you haven't, please refer to [Register as a huawei developer](https://developer.huawei.com/consumer/en/doc/start/10104). Refer to [HUAWEI Development Guide](https://developer.huawei.com/consumer/en/doc/development/HMS-Guides/wallet-preparations) to apply for a service for one of the six passes. 
...
If you run into a bug in our samples, please submit an [issue](https://github.com/HMS-Core/hms-scan-demo/issues) to the Repository. Even better you can submit a [Pull Request](https://github.com/HMS-Core/hms-wallet-severdemo/pulls) with a fix.
